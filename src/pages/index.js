...
const IndexPage = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <div>
        {/* ###############################    HEADER START ########################################### */}
        <div className={`${albumStyle.slope} bg-gray-00`} />
        <div
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Box-To-Box Podcast by Phil McCormick and friends. SUBSCRIBE NOW your
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            description of the podcast is not detailed enough therefore not good
            for discoverability
          </div>
